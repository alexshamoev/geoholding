	...
	<body>
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-12 mt-5 login p-2">
                    ...
                    <div class="d-flex align-items-center login__header">
                        ...
                        <div class="d-flex flex-column ps-4">
                            ...
                            <div>Created By <a href="#">HobbyStudio</a></div>
                        </div>
                    </div>
                    ...
                    <div class="login__body p-2">
                        <form method="POST" action="{{ route('adminLogin') }}" id="login_form">
                            ...
                            <div class="login__input_wrapper row flex-column p-3 mb-4">
                                <label for="email" class="col-md-4 pt-0 pb-1 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                            ...
                            <div class="login__input_wrapper row flex-column p-3">
                                <label for="password" class="col-md-4 pt-0 pb-1 col-form-label text-md-right">{{ __('Password') }}</label>
